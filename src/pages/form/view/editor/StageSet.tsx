...
import {faArrowCircleDown, faArrowCircleUp, faPlusCircle, faTimesCircle} from "@fortawesome/free-solid-svg-icons";
...
const StageSet: React.FunctionComponent<StageSetProps> = (
    ...
    return (<div>
        ...
        <div className={classes(styles.stageSet, selected ? styles.selected : undefined)}>
            <div className={styles.horizontal}>
                <div className={classes(styles.left, styles.movement)}>
                    <FontAwesomeIcon icon={faArrowCircleUp} onClick={() => onMove('up')}/>
                    <FontAwesomeIcon icon={faArrowCircleDown} onClick={() => onMove('down')}/>
                    <FontAwesomeIcon icon={faTimesCircle} onClick={() => onRemove()}/>
                </div>
                <div className={styles.right}>
                <span>
                    <div onClick={onClick}>{'title' in set ? set.title : `Stage ${(idx ?? 0) + 1}`}</div>
                    <div>
