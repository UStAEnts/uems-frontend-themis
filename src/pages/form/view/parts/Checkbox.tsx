...
export const CheckboxEditPart: React.FunctionComponent<CheckboxConfiguration & {
...
const CheckboxPart: React.FunctionComponent<CheckboxConfiguration & { onCheckChange?: (value: boolean) => void }> = (props) => {
