...
export const FormEditElement: React.FunctionComponent<BasePartEditType> = (
	props
) => {
			...
			<div className={styles.bottom}>
				<div className={styles.requiredSelect}>
					...
					<input
						...
						ref={required}
						onChange={() =>
							props.onRequiredChange(required.current?.checked ?? false)
						}
					/>
				</div>
				<div className={styles.typeSelect}>
					<Select
						...
						onSelectListener={(v: KeyValueOption) =>
							props.onTypeChange(v.value as StageType['type'])
						}
					/>
				</div>
			</div>
