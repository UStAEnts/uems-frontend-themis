...
export const DateRangeEditPart: React.FunctionComponent<DateRangeConfiguration & {
...
const DateRangePart: React.FunctionComponent<DateRangeConfiguration & { onDateRangeChange?: (start: Date | null, end: Date | null) => void }> = (
    props
) => {
    const [start, setStart] = useState<Date | null>(props.value ? new Date(props.value.start * 1000) : null);
    const [end, setEnd] = useState<Date | null>(props.value ? new Date(props.value.end * 1000) : null);
