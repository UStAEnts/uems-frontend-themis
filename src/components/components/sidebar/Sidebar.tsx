...
const Conditional: React.FunctionComponent<{ predicate: boolean | (() => boolean) }> = ({ predicate, children }) => {
	...
	return (
		<div className={ and(classes.sidebar, classes.expanded) }>
			<img className={ classes.header } src={ "/ents-crew-white.png" } style={ { filter: 'invert(1)' } }
				 alt={ "UEMS Logo: the text UEMS in a geometric font at the bottom of a black stroked rectangle" }/>
			...
			<div className={ and(classes.marker, ait(/\/events\/?.*/)) }>
				<NavLink to="/events" className={ classes.navigationLink } onClick={ navLinkClick }
						 activeClassName={ classes.active }>
					<div className={ classes.icon }>
						<MdiTicketOutline/>
					</div>
			...
			<div className={ and(classes.marker, ait(/\/venues\/?.*/)) }>
				<NavLink to="/venues" className={ classes.navigationLink } onClick={ navLinkClick }
						 activeClassName={ classes.active }>
					<div className={ classes.icon }>
						<MdiMapMarkerOutline/>
					</div>
			...
			<div className={ and(classes.marker, ait(/\/ents\/?.*/)) }>
				<NavLink to="/ents" className={ classes.navigationLink } onClick={ navLinkClick }
						 activeClassName={ classes.active }>
					<div className={ classes.icon }>
			...
			<div className={ and(classes.marker, ait(/\/states\/?.*/)) }>
				<NavLink to="/states" className={ classes.navigationLink } onClick={ navLinkClick }
						 activeClassName={ classes.active }>
					<div className={ classes.icon }>
						<MdiLabelOutline/>
					</div>
			...
			<div className={ and(classes.marker, ait(/\/topics\/?.*/)) }>
				<NavLink to="/topics" className={ classes.navigationLink } onClick={ navLinkClick }
						 activeClassName={ classes.active }>
					<div className={ classes.icon }>
						<MdiCardTextOutline/>
					</div>
			...
			<Conditional predicate={ () => ctx.features.value?.equipment ?? false }>
				<div className={ and(classes.marker, ait(/\/equipment\/?.*/)) }>
					<NavLink to="/equipment" className={ classes.navigationLink } onClick={ navLinkClick }
							 activeClassName={ classes.active }>
						<div className={ classes.icon }>
							<MdiToolBoxOutline/>
						</div>
			...
			<Conditional predicate={ () => ctx.features.value?.ops ?? false }>
				<NavLink to="/workflow/ops" exact className={ classes.navigationLink } onClick={ navLinkClick }
						 activeClassName={ classes.active }>
					<div className={ classes.icon }>
						<MdiSendOutline/>
					</div>
