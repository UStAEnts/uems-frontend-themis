...
export function processNotifications(
	...
	for (const notification of notifications) {
		...
		if (
			animationStates &&
			Object.prototype.hasOwnProperty.call(animationStates, notification.id)
		) {
...
export class NotificationRenderer extends React.Component<
...
> {
	...
	private makeNotification = (notification: Notification) => {
		...
		return (
			<div
				className={`notification with-icon ${notification.state || ''}`}
				key={notification.id}
			>
				<div className="content">
					<div className="rest">
						...
						<div className="right">
							<IconBox
								...
								color={notification.color || '#000000'}
							/>
						</div>
					</div>
					<div
