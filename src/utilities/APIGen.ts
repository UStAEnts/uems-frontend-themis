...
* This file was generated on 2021-01-02T13:17:10.942Z.
*/
    ...
    if (validator && !validator.check(data)) {
        ...
        try {
            ...
            if (e instanceof ZodError) {
                ...
                console.groupCollapsed('Suberrors');
...
export const IDOnlyResponseZod = z.array(z.string().optional());
...
export const EntsStateCreationZod = EntsStateUpdateZod.omit({ name: true, icon: true, color: true }).extend({
    name: z.string(),
    color: z.string(),
    icon: z.string(),
});
...
export const EventResponseZod = EventCreationZod.omit({ venue: true, ents: true, state: true }).extend({
