...
* This file was generated on 2020-07-28T21:31:45.914Z.
*/
    ...
    if (validator && !validator.check(data)) {
        ...
        try {
            ...
            if (e instanceof ZodError) {
                console.warn(`Invalid data received from ${uri}. Parsed to produce errors`);
...
function request(
    ...
    if (override) {
        console.debug(`A request to ${uri} blocked by API override "${override.name}" to return a fixed response`);
...
export const ErrorMessageZod = z.object({
    code: z.string(),
    message: z.string(),
});
export type ErrorMessage = z.infer<typeof ErrorMessageZod>;
export const IDOnlyResponseZod = z.object({
    id: z.string(),
});
...
export const DKASZMTGSHUnknownIdentifierZod = IDOnlyResponseZod.extend({
    uploadURI: z.string(),
});
export type DKASZMTGSHUnknownIdentifier = z.infer<typeof DKASZMTGSHUnknownIdentifierZod>;
export const YLOKMZSVYIUnknownIdentifierZod = IDOnlyResponseZod.extend({
    uploadURI: z.string(),
});
export type YLOKMZSVYIUnknownIdentifier = z.infer<typeof YLOKMZSVYIUnknownIdentifierZod>;
...
export const PostFilesAPIResponseZod = SuccessfulAPIResponseZod.extend({
    result: YLOKMZSVYIUnknownIdentifierZod,
});
...
export type APIType = {
    events: {
        ...
        id: {
            get: (id: string)
                => Promise<GetEventsIdAPIResponse>,
            patch: (id: string, body: EventUpdate)
                => Promise<UpdateEventAPIResponse>,
            delete: (id: string)
                => Promise<void>,
            comments: {
                get: (id: string)
                    => Promise<GetEventsIdCommentsAPIResponse>,
                post: (id: string, body: CommentUpdate)
                    => Promise<PostEventsIdCommentsAPIResponse>,
                id: {
                    get: (id: string, comment: string)
                        => Promise<GetEventsIdCommentsCommentAPIResponse>,
            ...
            files: {
                get: (id: string)
                    => Promise<GetEventsIdFilesAPIResponse>,
                post: (id: string, body: object)
                    => Promise<PostEventsIdFilesAPIResponse>,
                id: {
                    get: (id: string, file: string)
                        => Promise<GetEventsIdFilesFileAPIResponse>,
                    delete: (id: string, file: string)
                        => Promise<void>
                }
            },
            signups: {
                get: (id: string)
                    => Promise<GetEventsIdSignupsAPIResponse>,
                post: (id: string, body: SignupCreation)
                    => Promise<PostEventsIdSignupsAPIResponse>,
                id: {
                    get: (id: string, signup: string)
                        => Promise<GetEventsIdSignupsSignupAPIResponse>,
                    patch: (id: string, signup: string, body: SignupUpdate)
                        => Promise<PatchEventsIdSignupsSignupAPIResponse>,
                    delete: (id: string, signup: string)
                        => Promise<void>
                }
            }
        }
    ...
    files: {
        ...
        post: (body: FileCreation)
            => Promise<PostFilesAPIResponse>,
        id: {
            get: (id: string)
                => Promise<GetFilesIdAPIResponse>,
            patch: (id: string, body: FileUpdate)
                => Promise<PatchFilesIdAPIResponse>,
            delete: (id: string)
                => Promise<void>,
            events: {
                get: (id: string)
                    => Promise<GetFilesIdEventsAPIResponse>
            },
            comments: {
                get: (id: string)
                    => Promise<GetFilesIdCommentsAPIResponse>,
                post: (id: string, body: CommentUpdate)
                    => Promise<PostFilesIdCommentsAPIResponse>,
                id: {
                    get: (id: string, comment: string)
                        => Promise<GetFilesIdCommentsCommentAPIResponse>,
                    patch: (id: string, comment: string, body: CommentUpdate)
    ...
    users: {
        ...
        id: {
            get: (id: string)
                => Promise<GetUsersIdAPIResponse>
        }
    },
    ents: {
        get: ()
            => Promise<GetEntsAPIResponse>,
        post: (body: EntsStateCreation)
            => Promise<PostEntsAPIResponse>,
        id: {
            get: (id: string)
                => Promise<GetEntsIdAPIResponse>,
            patch: (id: string, body: EntsStateUpdate)
                => Promise<PatchEntsIdAPIResponse>,
            delete: (id: string)
                => Promise<void>
        }
    },
    states: {
        ...
        post: (body: StateCreation)
            => Promise<PostStatesAPIResponse>,
        id: {
            get: (id: string)
                => Promise<GetStatesIdAPIResponse>,
            patch: (id: string, body: StateUpdate)
                => Promise<PatchStatesIdAPIResponse>,
            delete: (id: string)
                => Promise<void>,
            events: {
                get: (id: string)
    ...
    topics: {
        get: ()
            => Promise<GetTopicsAPIResponse>,
        post: (body: TopicCreation)
            => Promise<PostTopicsAPIResponse>,
        id: {
            get: (id: string)
                => Promise<GetTopicsIdAPIResponse>,
            patch: (id: string, body: TopicUpdate)
                => Promise<PatchTopicsIdAPIResponse>,
            delete: (id: string)
                => Promise<void>
        }
    },
    venues: {
        get: ()
            => Promise<GetVenueAPIResponse>,
        post: (body: VenueCreation)
            => Promise<PostVenueAPIResponse>,
        id: {
            get: (id: string)
                => Promise<GetVenueIdAPIResponse>,
            patch: (id: string, body: VenueUpdate)
                => Promise<PatchVenueIdAPIResponse>,
            delete: (id: string)
                => Promise<void>,
            events: {
                get: (id: string)
                    => Promise<GetVenuesIdEventsAPIResponse>
            }
        }
    }
}
