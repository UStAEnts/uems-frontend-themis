...
* This file was generated on 2020-07-27T11:58:29.999Z.
*/
...
function request(
    ...
    if (override) {
        console.debug(`A request to ${uri} was intercepted by API
        override "${override.name}" to return a fixed response`);
