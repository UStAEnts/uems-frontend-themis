     ...
     */ post = (): Promise<UEMSResponse<ModifyResponse>> => {
        return this._http.post(
            `/events/${encodeURIComponent(
                this.id
            )}/comments/${encodeURIComponent(this.commentID)}/attention`,
            undefined,
            undefined
        );
    };
...
class APIEventsIdCommentsCommentIDResolve {
     ...
     */ post = (): Promise<UEMSResponse<ModifyResponse>> => {
        return this._http.post(
            `/events/${encodeURIComponent(
                this.id
            )}/comments/${encodeURIComponent(this.commentID)}/resolve`,
            undefined,
            undefined
        );
    };
...
class APIEventsEventIDFilesFileID {
     ...
     */ delete = (): Promise<UEMSResponse<ModifyResponse>> => {
        return this._http.delete(
            `/events/${encodeURIComponent(
                this.eventID
            )}/files/${encodeURIComponent(this.fileID)}`,
            undefined
        );
    };
}
...
class APIEventsEventIDFiles {
    ...
    fileID = (parameter: string): APIEventsEventIDFilesFileID => {
        return new APIEventsEventIDFilesFileID(
            this._http,
            this.eventID,
            parameter
        );
...
class APIEventsEventIDSignupsId {
     ...
     */ get = (): Promise<UEMSResponse<Signup>> => {
        return this._http.get(
            `/events/${encodeURIComponent(
                this.eventID
            )}/signups/${encodeURIComponent(this.id)}`,
            undefined
        );
    };
...
class APIEventsEventIDSignups {
    ...
    id = (parameter: string): APIEventsEventIDSignupsId => {
        return new APIEventsEventIDSignupsId(
            this._http,
            this.eventID,
            parameter
        );
...
class APIFiles {
     ...
     *
     */ get = (
        query: APIFilesGetQuery
    ): Promise<UEMSResponse<UEMSFileList>> => {
