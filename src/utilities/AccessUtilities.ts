export function get<T, P1 extends keyof T>(
	obj: T,
	prop1: P1
): T[P1] | undefined;

export function get<T, P1 extends keyof T, P2 extends keyof T[P1]>(
	obj: T,
	prop1: P1,
	prop2: P2
): T[P1][P2] | undefined;
...
>(obj: T, prop1: P1, prop2: P2, prop3: P3): T[P1][P2][P3] | undefined;
...
export function get(obj: any, ...props: string[]): any {
	return (
		...
		props.reduce(
			(result, prop) =>
				result === undefined || result === null ? undefined : result[prop],
			obj
		)
	);
}

export function failEarlySet<T, P1 extends keyof T>(
	obj: T,
	prop1: P1
): (value: T[P1]) => boolean;

export function failEarlySet<T, P1 extends keyof T, P2 extends keyof T[P1]>(
	obj: T,
	prop1: P1,
	props2: P2
): (value: T[P1][P2]) => boolean;

export function failEarlySet<
	T,
	P1 extends keyof T,
	P2 extends keyof T[P1],
	P3 extends keyof T[P1][P2]
>(obj: T, prop1: P1, props2: P2, props3: P3): (value: T[P1][P2][P3]) => boolean;
...
export function failEarlyStateSet<T, P1 extends keyof T>(
	state: T,
	setState: (set: SetStateType<T>) => any,
	prop1: P1
): (value: T[P1]) => void;

export function failEarlyStateSet<
	T,
	P1 extends keyof T,
	P2 extends keyof T[P1]
>(
...
export function failEarlyStateSet(
	obj: any,
	setState: (set: SetStateType<any>) => any,
	...props: string[]
) {
	if (!setState.name.startsWith('bound ')) {
		console.warn(
			'failEarlyStateSet: setState does not begin with "bound", if you have called it ' +
